                            ...
                            <div class="col">
                                ...
                                <section>
                                    <card gradient="secondary" shadow body-classes="">
                                        ...
                                        <base-button v-on:click="uploadQuestion" type="default" round block size="lg" > 提交问题 </base-button>
                                    </card>
                                </section>
                            </div>
                ...
                <div v-for="(item, index) in historyList" v-bind:key="index">
                    <div class="row">
                        ...
                        <div class="col-2" style="float:left;margin-top:5px">
                            <small style="margin-left:5px">{{formatDate_use(item[1]*1000)[1]}}</small>
                            <badge type="success">{{formatDate_use(item[1]*1000)[0]}}</badge>
                        </div>
